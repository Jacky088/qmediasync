...
- [ ] 本地目录同步源接入（可以兼容CD2, RClone等）(v0.8)
- [ ] 123云盘开放平台同步源接入（v0.8）
- [ ] 支持添加多个115或者123账号(v0.8)
- [ ] 支持文件名称的排除(v0.8.1)
- [ ] emby 302（集成go-emby2openlist库）(v0.9)
- [ ] 115多账号之间克隆媒体库(v0.9)
- [ ] 123秒传 + 多账号之间克隆媒体库(v0.9)
- [ ] 看是否可以申请到开放平台(ing)来对接阿里云盘(v0.10)
- [ ] 阿里云盘<->115秒传，依赖阿里云盘申请结果(v0.10)
- [ ] 企业微信、server酱、MeoW(鸿蒙专用) 通知接入(v0.11)
- [ ] 百度网盘同步源接入(v0.12)
- [ ] 影视剧刮削（正在评估复杂度）
- [ ] 如果刮削过，可以根据nfo进行文件整理(正在评估复杂度)
